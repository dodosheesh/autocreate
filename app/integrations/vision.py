...
REVERSE_ENGINEER_VIDEO_SYSTEM = (
    ...
    "TEMPLATE that captures the SUBJECT'S ACTION, FRAMING, PACING and MOOD of the clip, "
    "as a realistic 9:16 vertical phone video for social media. "
    "IMPORTANT: assume the girl is filming herself on a STATIC phone camera — describe "
    "her actions and gestures, NOT camera moves. Do NOT add push-ins, zooms, dolly, "
    "orbits or any camera movement, and do NOT make it 'cinematic'; it must look like a "
    "real TikTok/Reels phone recording, not AI-generated. "
